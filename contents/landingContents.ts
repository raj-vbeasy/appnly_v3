...
export const landingContents = {
                ...
                items: [
                    {
                        ...
                        content: "Create, update, or delete calendar events based on external data or use, input."
                    },
                    {
                        imageSrc: "/assets/svgs/information-circle.svg",
                        title: "Google Forms Enhancements",
                        content: "Automatically send confirmation emails, Validate form responses in real-time, Sync form data with Google Sheets."
                    },
                    {
                        imageSrc: "/assets/svgs/document-chart-bar.svg",
    ...
    pricing: {
        ...
        pricingList: [
            ...
            {
                title: "Ongoing Admin",
                content: "Everything you need to run your a business for 10x Efficiency",
            ...
            },
            {
                ...
                content: "Complex automation system for big corporation",
                price: "200$",
                button: {
                    type: "hollow",
                    text: "Get Started"
